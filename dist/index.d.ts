...
export declare function createQuery(client: PoolClient | Pool | string): <R extends QueryResultRow = any, I extends any[] = any[]>(literals: ReadonlyArray<string>, ...values: I) => Promise<import("pg").QueryResult<R>>;
